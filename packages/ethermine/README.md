...
[![npm](https://img.shields.io/npm/v/zaida04/ethermine-js?color=crimson&logo=npm)](https://www.npmjs.com/package/zaida04/ethermine-js)
...
## Installation
- `npm install ethermine-js`  
- `yarn add ethermine-js`
